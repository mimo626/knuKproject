...
function Main() {
    ...
    return (
        <FieldWrapper>
            <Link to={department === undefined ?  '/' : '/field/major/'+ department +'/page/1'} style={{ textDecoration: "none"}}><FieldUniv >{department === undefined || department === null? "학부/선택" : department}</FieldUniv></Link>
